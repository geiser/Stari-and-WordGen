...
saveRDS(
  ...
  file = 'stWG-ancova-scoreCLPPpos-from-scoreCLPPpre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-scoreCLPPpos-from-scoreCLPPpre-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-scoreCLPPpos-from-scoreCLPPpre-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-scoreCLPPpos-from-scoreCLPPpre-grupo-zonaescola.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-stWG-score.CLPP-emms.rds')
```
