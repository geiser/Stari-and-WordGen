---
title: "ANCOVA in Reading Words and Pseudowords (Reading Words and Pseudowords)"
author: Geiser C. Challco <geiser@alumni.usp.br>
comment: Teste ANCOVA para determinar se houve diferenças significativas
         na Reading Words and Pseudowords (medido usando pre- e pos-testes).
         
         ANCOVA test to determine whether there were significant differences
         in Reading Words and Pseudowords (measured using pre- and post-tests).
...
no Reading Words and Pseudowords (medido usando pre- e pos-testes).
 - ANCOVA test to determine whether there were significant differences
in Reading Words and Pseudowords (measured using pre- and post-tests).
...
saveRDS(
  ...
  file = 'wg-ancova-scoreCLPPpos-from-scoreCLPPpre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-scoreCLPPpos-from-scoreCLPPpre-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-scoreCLPPpos-from-scoreCLPPpre-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-scoreCLPPpos-from-scoreCLPPpre-grupo-zonaescola.rds')
```
...
saveRDS(
  list(
    ...
    dv = "score.CLPP.pos",
    covar = "score.CLPP.pre",
    iv = c("grupo","score.CLPP.quintile"),
    wid = "id",
    transformation = "none",
    outliers = list(method = "none"),
    non.normality = non.normal,
  ...
  file = 'wg-ancova-scoreCLPPpos-from-scoreCLPPpre-grupo-scoreCLPPquintile.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-wordgen-score.CLPP-emms.rds')
```
