...
saveRDS(
  list(
    test = "ancova",
    dv = "score.vocab.ensinado.pos",
    covar = "score.vocab.ensinado.pre",
    iv = c("grupo"),
    wid = "id",
    transformation = "none",
  ...
  file = 'wg-ancova-scorevocabensinadopos-from-scorevocabensinadopre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-scorevocabensinadopos-from-scorevocabensinadopre-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-scorevocabensinadopos-from-scorevocabensinadopre-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-scorevocabensinadopos-from-scorevocabensinadopre-grupo-zonaescola.rds')
```
...
saveRDS(
  list(
    ...
    dv = "score.vocab.ensinado.pos",
    covar = "score.vocab.ensinado.pre",
    iv = c("grupo","score.vocab.ensinado.quintile"),
    wid = "id",
    transformation = "none",
    outliers = list(method = "none"),
    non.normality = non.normal,
  ...
  file = 'wg-ancova-scorevocabensinadopos-from-scorevocabensinadopre-grupo-scorevocabensinadoquintile.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-wordgen-score.vocab.ensinado-emms.rds')
```
