...
saveRDS(
  ...
  file = 'stWG-ancova-scorevocabpos-from-scorevocabpre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-scorevocabpos-from-scorevocabpre-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-scorevocabpos-from-scorevocabpre-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-scorevocabpos-from-scorevocabpre-grupo-zonaescola.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-stWG-score.vocab-emms.rds')
```
