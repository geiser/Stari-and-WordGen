...
saveRDS(
  ...
  file = 'stWG-ancova-scorevocabensinadopos-from-scorevocabensinadopre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-scorevocabensinadopos-from-scorevocabensinadopre-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-scorevocabensinadopos-from-scorevocabensinadopre-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-scorevocabensinadopos-from-scorevocabensinadopre-grupo-zonaescola.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-stWG-score.vocab.ensinado-emms.rds')
```
