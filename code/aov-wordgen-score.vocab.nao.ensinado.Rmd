---
title: "ANCOVA in Vocabulary not taught (Vocabulary not taught)"
author: Geiser C. Challco <geiser@alumni.usp.br>
comment: Teste ANCOVA para determinar se houve diferenças significativas
         na Vocabulary not taught (medido usando pre- e pos-testes).
         
         ANCOVA test to determine whether there were significant differences
         in Vocabulary not taught (measured using pre- and post-tests).
...
no Vocabulary not taught (medido usando pre- e pos-testes).
 - ANCOVA test to determine whether there were significant differences
in Vocabulary not taught (measured using pre- and post-tests).
...
saveRDS(
  list(
    test = "ancova",
    dv = "score.vocab.nao.ensinado.pos",
    covar = "score.vocab.nao.ensinado.pre",
    iv = c("grupo"),
    wid = "id",
    transformation = "none",
  ...
  file = 'wg-ancova-scorevocabnaoensinadopos-from-scorevocabnaoensinadopre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-scorevocabnaoensinadopos-from-scorevocabnaoensinadopre-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-scorevocabnaoensinadopos-from-scorevocabnaoensinadopre-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-scorevocabnaoensinadopos-from-scorevocabnaoensinadopre-grupo-zonaescola.rds')
```
...
saveRDS(
  list(
    ...
    dv = "score.vocab.nao.ensinado.pos",
    covar = "score.vocab.nao.ensinado.pre",
    iv = c("grupo","score.vocab.nao.ensinado.quintile"),
    wid = "id",
    transformation = "none",
    outliers = list(method = "none"),
    non.normality = non.normal,
  ...
  file = 'wg-ancova-scorevocabnaoensinadopos-from-scorevocabnaoensinadopre-grupo-scorevocabnaoensinadoquintile.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-wordgen-score.vocab.nao.ensinado-emms.rds')
```
