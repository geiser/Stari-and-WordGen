...
saveRDS(
  ...
  file = 'wg-ancova-scoreCRpos-from-scoreCRpre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-scoreCRpos-from-scoreCRpre-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-scoreCRpos-from-scoreCRpre-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-scoreCRpos-from-scoreCRpre-grupo-zonaescola.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-scoreCRpos-from-scoreCRpre-grupo-scoreCRquintile.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-wordgen-score.CR-emms.rds')
```
