...
saveRDS(
  ...
  file = 'stWG-ancova-scorevocabnaoensinadopos-from-scorevocabnaoensinadopre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-scorevocabnaoensinadopos-from-scorevocabnaoensinadopre-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-scorevocabnaoensinadopos-from-scorevocabnaoensinadopre-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-scorevocabnaoensinadopos-from-scorevocabnaoensinadopre-grupo-zonaescola.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-stWG-score.vocab.nao.ensinado-emms.rds')
```
