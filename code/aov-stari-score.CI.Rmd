...
saveRDS(
  ...
  file = 'st-ancova-scoreCIpos-from-scoreCIpre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scoreCIpos-from-scoreCIpre-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scoreCIpos-from-scoreCIpre-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scoreCIpos-from-scoreCIpre-grupo-zonaescola.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scoreCIpos-from-scoreCIpre-grupo-scoreCIquintile.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-stari-score.CI-emms.rds')
```
