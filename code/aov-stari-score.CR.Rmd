...
saveRDS(
  ...
  file = 'st-ancova-scoreCRpos-from-scoreCRpre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scoreCRpos-from-scoreCRpre-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scoreCRpos-from-scoreCRpre-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scoreCRpos-from-scoreCRpre-grupo-zonaescola.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scoreCRpos-from-scoreCRpre-grupo-scoreCRquintile.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-stari-score.CR-emms.rds')
```
