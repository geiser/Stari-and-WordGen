---
title: "ANCOVA in flow (debat) (flow (debat))"
author: Geiser C. Challco <geiser@alumni.usp.br>
comment: Teste ANCOVA para determinar se houve diferenças significativas
         na flow (debat) (medido usando pre- e pos-testes).
...
no flow (debat) (medido usando pre- e pos-testes).
 - ANCOVA test to determine whether there were significant differences
in flow (debat) (measured using pre- and post-tests).
...
saveRDS(
  ...
  file = 'stWG-ancova-fssdebate-from-dfsdebate-grupo.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-fssdebate-from-dfsdebate-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-fssdebate-from-dfsdebate-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-fssdebate-from-dfsdebate-grupo-zonaescola.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-stWG-flow.debat-emms.rds')
```
