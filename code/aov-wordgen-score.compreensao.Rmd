...
saveRDS(
  list(
    test = "ancova",
    dv = "score.compreensao.pos",
    covar = "score.compreensao.pre",
    iv = c("grupo"),
    wid = "id",
    transformation = "none",
  ...
  file = 'wg-ancova-scorecompreensaopos-from-scorecompreensaopre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-scorecompreensaopos-from-scorecompreensaopre-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-scorecompreensaopos-from-scorecompreensaopre-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-scorecompreensaopos-from-scorecompreensaopre-grupo-zonaescola.rds')
```
...
saveRDS(
  list(
    ...
    dv = "score.compreensao.pos",
    covar = "score.compreensao.pre",
    iv = c("grupo","score.compreensao.quintile"),
    wid = "id",
    transformation = "none",
    outliers = list(method = "none"),
    non.normality = non.normal,
  ...
  file = 'wg-ancova-scorecompreensaopos-from-scorecompreensaopre-grupo-scorecompreensaoquintile.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-wordgen-score.compreensao-emms.rds')
```
