...
saveRDS(
  ...
  file = 'stWG-ancova-scorecompreensaopos-from-scorecompreensaopre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-scorecompreensaopos-from-scorecompreensaopre-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-scorecompreensaopos-from-scorecompreensaopre-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-scorecompreensaopos-from-scorecompreensaopre-grupo-zonaescola.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-stWG-score.compreensao-emms.rds')
```
