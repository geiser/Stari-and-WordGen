...
saveRDS(
  ...
  file = 'st-ancova-palavraslidaspos-from-palavraslidaspre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-palavraslidaspos-from-palavraslidaspre-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-palavraslidaspos-from-palavraslidaspre-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-palavraslidaspos-from-palavraslidaspre-grupo-zonaescola.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-palavraslidaspos-from-palavraslidaspre-grupo-palavraslidasquintile.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-stari-palavras.lidas-emms.rds')
```
