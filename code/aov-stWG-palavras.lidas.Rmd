...
saveRDS(
  ...
  file = 'stWG-ancova-palavraslidaspos-from-palavraslidaspre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-palavraslidaspos-from-palavraslidaspre-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-palavraslidaspos-from-palavraslidaspre-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-palavraslidaspos-from-palavraslidaspre-grupo-zonaescola.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-stWG-palavras.lidas-emms.rds')
```
