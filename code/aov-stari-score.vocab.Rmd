...
saveRDS(
  ...
  file = 'st-ancova-scorevocabpos-from-scorevocabpre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scorevocabpos-from-scorevocabpre-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scorevocabpos-from-scorevocabpre-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scorevocabpos-from-scorevocabpre-grupo-zonaescola.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scorevocabpos-from-scorevocabpre-grupo-scorevocabquintile.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-stari-score.vocab-emms.rds')
```
