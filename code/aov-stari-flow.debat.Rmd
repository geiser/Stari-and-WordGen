...
saveRDS(
  ...
  file = 'st-ancova-fssdebate-from-dfsdebate-grupo.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-fssdebate-from-dfsdebate-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-fssdebate-from-dfsdebate-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-fssdebate-from-dfsdebate-grupo-zonaescola.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-stari-flow.debat-emms.rds')
```
