...
saveRDS(
  ...
  file = 'st-ancova-scoreCLPPpos-from-scoreCLPPpre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scoreCLPPpos-from-scoreCLPPpre-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scoreCLPPpos-from-scoreCLPPpre-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scoreCLPPpos-from-scoreCLPPpre-grupo-zonaescola.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scoreCLPPpos-from-scoreCLPPpre-grupo-scoreCLPPquintile.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-stari-score.CLPP-emms.rds')
```
