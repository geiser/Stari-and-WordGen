...
saveRDS(
  ...
  file = 'st-ancova-scorecompreensaopos-from-scorecompreensaopre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scorecompreensaopos-from-scorecompreensaopre-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scorecompreensaopos-from-scorecompreensaopre-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scorecompreensaopos-from-scorecompreensaopre-grupo-zonaescola.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scorecompreensaopos-from-scorecompreensaopre-grupo-scorecompreensaoquintile.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-stari-score.compreensao-emms.rds')
```
