---
title: "ANCOVA in Reading Words (1 Min) (Reading Words (1 Min))"
author: Geiser C. Challco <geiser@alumni.usp.br>
comment: Teste ANCOVA para determinar se houve diferenças significativas
         na Reading Words (1 Min) (medido usando pre- e pos-testes).
         
         ANCOVA test to determine whether there were significant differences
         in Reading Words (1 Min) (measured using pre- and post-tests).
...
no Reading Words (1 Min) (medido usando pre- e pos-testes).
 - ANCOVA test to determine whether there were significant differences
in Reading Words (1 Min) (measured using pre- and post-tests).
...
saveRDS(
  list(
    test = "ancova",
    dv = "palavras.lidas.pos",
    covar = "palavras.lidas.pre",
    iv = c("grupo"),
    wid = "id",
    transformation = "none",
  ...
  file = 'wg-ancova-palavraslidaspos-from-palavraslidaspre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-palavraslidaspos-from-palavraslidaspre-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-palavraslidaspos-from-palavraslidaspre-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-palavraslidaspos-from-palavraslidaspre-grupo-zonaescola.rds')
```
...
saveRDS(
  list(
    ...
    dv = "palavras.lidas.pos",
    covar = "palavras.lidas.pre",
    iv = c("grupo","palavras.lidas.quintile"),
    wid = "id",
    transformation = "none",
    outliers = list(method = "none"),
    non.normality = non.normal,
  ...
  file = 'wg-ancova-palavraslidaspos-from-palavraslidaspre-grupo-palavraslidasquintile.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-wordgen-palavras.lidas-emms.rds')
```
