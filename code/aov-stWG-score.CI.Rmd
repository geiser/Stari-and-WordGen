...
saveRDS(
  ...
  file = 'stWG-ancova-scoreCIpos-from-scoreCIpre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-scoreCIpos-from-scoreCIpre-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-scoreCIpos-from-scoreCIpre-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-scoreCIpos-from-scoreCIpre-grupo-zonaescola.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-stWG-score.CI-emms.rds')
```
