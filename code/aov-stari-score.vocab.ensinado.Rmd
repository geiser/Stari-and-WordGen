...
saveRDS(
  ...
  file = 'st-ancova-scorevocabensinadopos-from-scorevocabensinadopre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scorevocabensinadopos-from-scorevocabensinadopre-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scorevocabensinadopos-from-scorevocabensinadopre-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scorevocabensinadopos-from-scorevocabensinadopre-grupo-zonaescola.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scorevocabensinadopos-from-scorevocabensinadopre-grupo-scorevocabensinadoquintile.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-stari-score.vocab.ensinado-emms.rds')
```
