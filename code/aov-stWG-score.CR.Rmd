...
saveRDS(
  ...
  file = 'stWG-ancova-scoreCRpos-from-scoreCRpre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-scoreCRpos-from-scoreCRpre-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-scoreCRpos-from-scoreCRpre-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-scoreCRpos-from-scoreCRpre-grupo-zonaescola.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-stWG-score.CR-emms.rds')
```
