...
saveRDS(
  ...
  file = 'st-ancova-fssleitura-from-dfsleitura-grupo.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-fssleitura-from-dfsleitura-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-fssleitura-from-dfsleitura-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-fssleitura-from-dfsleitura-grupo-zonaescola.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-stari-flow.read-emms.rds')
```
