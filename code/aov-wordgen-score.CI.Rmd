...
saveRDS(
  ...
  file = 'wg-ancova-scoreCIpos-from-scoreCIpre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-scoreCIpos-from-scoreCIpre-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-scoreCIpos-from-scoreCIpre-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-scoreCIpos-from-scoreCIpre-grupo-zonaescola.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-scoreCIpos-from-scoreCIpre-grupo-scoreCIquintile.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-wordgen-score.CI-emms.rds')
```
