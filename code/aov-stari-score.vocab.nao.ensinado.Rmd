...
saveRDS(
  ...
  file = 'st-ancova-scorevocabnaoensinadopos-from-scorevocabnaoensinadopre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scorevocabnaoensinadopos-from-scorevocabnaoensinadopre-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scorevocabnaoensinadopos-from-scorevocabnaoensinadopre-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scorevocabnaoensinadopos-from-scorevocabnaoensinadopre-grupo-zonaescola.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-scorevocabnaoensinadopos-from-scorevocabnaoensinadopre-grupo-scorevocabnaoensinadoquintile.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-stari-score.vocab.nao.ensinado-emms.rds')
```
