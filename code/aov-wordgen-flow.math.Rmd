...
saveRDS(
  ...
  file = 'wg-ancova-fssmatematica-from-dfsmatematica-grupo.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-fssmatematica-from-dfsmatematica-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-fssmatematica-from-dfsmatematica-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-fssmatematica-from-dfsmatematica-grupo-zonaescola.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-wordgen-flow.math-emms.rds')
```
