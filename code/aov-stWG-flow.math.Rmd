...
no flow (math) (medido usando pre- e pos-testes).
 - ANCOVA test to determine whether there were significant differences
in flow (math) (measured using pre- and post-tests).
...
saveRDS(
  ...
  file = 'stWG-ancova-fssmatematica-from-dfsmatematica-grupo.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-fssmatematica-from-dfsmatematica-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-fssmatematica-from-dfsmatematica-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'stWG-ancova-fssmatematica-from-dfsmatematica-grupo-zonaescola.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-stWG-flow.math-emms.rds')
```
