...
saveRDS(
  ...
  file = 'st-ancova-fsstextual-from-dfstextual-grupo.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-fsstextual-from-dfstextual-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-fsstextual-from-dfstextual-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'st-ancova-fsstextual-from-dfstextual-grupo-zonaescola.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-stari-flow.text-emms.rds')
```
