---
title: "ANCOVA in Vocabulary (Vocabulary)"
author: Geiser C. Challco <geiser@alumni.usp.br>
comment: Teste ANCOVA para determinar se houve diferenças significativas
         na Vocabulary (medido usando pre- e pos-testes).
...
no Vocabulary (medido usando pre- e pos-testes).
 - ANCOVA test to determine whether there were significant differences
in Vocabulary (measured using pre- and post-tests).
...
saveRDS(
  ...
  file = 'wg-ancova-scorevocabpos-from-scorevocabpre-grupo.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-scorevocabpos-from-scorevocabpre-grupo-genero.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-scorevocabpos-from-scorevocabpre-grupo-zonaparticipante.rds')
```
...
saveRDS(
  ...
  file = 'wg-ancova-scorevocabpos-from-scorevocabpre-grupo-zonaescola.rds')
```
...
saveRDS(
  list(
    ...
    dv = "score.vocab.pos",
    covar = "score.vocab.pre",
    iv = c("grupo","score.vocab.quintile"),
    wid = "id",
    transformation = "none",
    outliers = list(method = "none"),
    non.normality = non.normal,
  ...
  file = 'wg-ancova-scorevocabpos-from-scorevocabpre-grupo-scorevocabquintile.rds')
```
...
```{r include=FALSE}
### Saving ancova information
saveRDS(df, file = '/mnt/c/Users/geise/OneDrive/Workspace/Stari-and-WordGen/code/aov-wordgen-score.vocab-emms.rds')
```
